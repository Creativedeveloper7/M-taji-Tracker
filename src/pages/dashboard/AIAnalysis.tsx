  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div className="text-sm text-gray-800 dark:text-gray-400 mb-2">AI Detected Completion</div>
        ...
        <motion.div
          ...
          className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6"
        >
          <div className="text-sm text-gray-800 dark:text-gray-400 mb-2">Predicted Completion</div>
        ...
        <motion.div
          ...
          className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6"
        >
          <div className="text-sm text-gray-800 dark:text-gray-400 mb-2">Risk Level</div>
          <div className="text-2xl font-bold text-amber-500">Low</div>
          <div className="text-xs text-gray-800 dark:text-gray-400 mt-1">No anomalies detected</div>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6">
          ...
          <div className="h-64 flex items-center justify-center text-gray-800 dark:text-gray-400">
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6">
          ...
          <div className="space-y-3">
            {analysisData.milestones.length === 0 ? (
              <p className="text-gray-800 dark:text-gray-400 text-center py-4">No milestones tracked yet</p>
            ) : (
              analysisData.milestones.map((milestone: any) => (
                <div key={milestone.id} className="flex items-center justify-between">
                  <span className="text-gray-800 dark:text-gray-400">{milestone.name}</span>
