...
// This file provides location data for Kenya's administrative divisions
...
export const constituenciesByCounty: Record<string, string[]> = {
  ...
  'Kisii': ['Kitutu Chache North', 'Kitutu Chache South', 'Nyaribari Masaba', 'Nyaribari Chache', 'Bomachoge Borabu', 'Bomachoge Chache', 'Bobasi', 'Nyamira North', 'Nyamira South'],
  ...
  'Taita-Taveta': ['Mwatate', 'Wundanyi', 'Voi', 'Taveta'],
  'Bungoma': ['Bungoma North', 'Bungoma South', 'Bungoma East', 'Bungoma West', 'Bungoma Central', 'Webuye East', 'Webuye West', 'Sirisia', 'Tongaren', 'Kimilili'],
};

// Helper function to get constituencies for a county
export function getConstituenciesByCounty(county: string): string[] {
  return constituenciesByCounty[county] || [];
}

// Export for backward compatibility
export { KENYA_COUNTIES as kenyanCounties };
export { getConstituenciesByCounty as getConstituencies };
