...
export class MockSatelliteService {
  async captureSnapshot(
    ...
    const zoom = 17;
    const size = '512x512';
    const mapboxToken = process.env.MAPBOX_ACCESS_TOKEN || 'pk.your-token-here';
...
export const mockSatelliteService = new MockSatelliteService();
